...
objList.push(
 new Obj(polygon[5], "rgb(0, 255, 0)", 100, 250, 100, true, (THIS) => {
...
function drawAll()
{
	...
	ctx.fillText("9", 0, 20);
	ctx.fillText("mouseActive=" + mouseActive, 0, 40);
	ctx.fillText("clickOn=" + clickOn, 0, 60);
	ctx.fillText("clickOff=" + clickOff, 0, 80);
	ctx.fillText("clicking=" + clicking, 0, 100);
	ctx.fillText(
	 "mouseCoord=[" + mouseCoord[0] + ", " + mouseCoord[1] + "]", 0, 120);
	ctx.fillText("zoomMouse=[" + zoomMouse[0] + ", " + zoomMouse[1] + "]",
		     0, 140);
